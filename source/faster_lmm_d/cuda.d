...
void gpu_blas_mmul(const double *A, const double *B, double *C, const m_items _m, const m_items _k, const m_items _n) {
...
DMatrix cuda_matrix_mult(const DMatrix rha, const DMatrix lha){
  ...
  cudaMalloc(cast(void **)&d_A,nr_rows_A * nr_cols_A * to!uint(double.sizeof));
  cudaMalloc(cast(void **)&d_B,nr_rows_B * nr_cols_B * to!uint(double.sizeof));
  cudaMalloc(cast(void **)&d_C,nr_rows_C * nr_cols_C * to!uint(double.sizeof));
