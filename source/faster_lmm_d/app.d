...
void main(string[] args)
{
  ...
  if(option_kinship != ""){
    ...
    if (cmd == "gk"){
      ...
      lm_run(option_anno, option_pheno, option_covar, option_geno, option_bfile, option_lm);
    }
    else if(cmd == "logistic"){
      logistic_reg_run(option_anno, option_pheno, option_covar, option_geno, option_bfile);
    }
    else{
