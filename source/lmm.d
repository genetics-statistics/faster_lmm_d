...
void run_gwas(string species,string n,string m,string k,string y,string geno,string cov,bool reml = true,bool refit = false, string inputfn = "", bool new_code = true){
  //"""
