...
then
echo "testBXDMultivariateLinearMixedModel()"
./build/faster_lmm_d -bfile=data/gemma//HLC -pheno=data/gemma/HLC.simu.pheno.txt -kinship=PlinkStandardRelatednessMatrixK.txt --lmm=1 --maf=0.1 --n=12 3 15 --c=$datadir/HLC_covariates.txt
fi
